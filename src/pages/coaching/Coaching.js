  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.content}>
        <span className={styles.name}>Vrolijke Noo<span className={styles.noot}>♪</span>zaak</span> biedt Personal en Professional Coaching en Mediation.
        Individuele coaching: Coachgesprekken, gemiddeld heb je 3-8 gesprekken
        afgewisseld met tussentijds online contact en een intake. Thema’s kunnen
        zijn:
        <ul>
