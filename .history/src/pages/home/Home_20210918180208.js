...
import BlokHalf from "../../components/blokHalf/BlokHalf";
  ...
  const quoteJet = () => {
    return (
      <div>
        ...
        <p>
        Ik help jullie om jezelf en elkaar positief te bekrachtigen. Ik heb een sterk ontwikkelde sensor voor de impact die mensen op zichzelf of elkaar hebben. Daarbij benut ik de impact van mij op anderen en anderen op mij.
  
  Ik werk transparant en benoem wat ik in het hier en nu ervaar. Ik ga op zoek naar het talent van mensen en spreek ze daarop aan. Ik pak waar nodig hardnekkige patronen, stiekeme geneugtes en blinde vlekken aan."
        </p>
      </div>
    );
  };
