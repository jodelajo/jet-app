      ...
      <div>
        ...
        <p>
          ...
          <ul className={styles.list}>
            <li><FaAsterisk className={styles.icon}/>empathisch</li>
            <li><FaAsterisk className={styles.icon}/>proactief</li>
            <li><FaAsterisk className={styles.icon}/>bevlogen</li>
            <li><FaAsterisk className={styles.icon}/>inspirerend</li>
            </ul>
        </p>
        {/* <p>
