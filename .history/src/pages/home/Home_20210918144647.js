      ...
      <main className={styles.homeMain}>
        ...
        <div className={styles.drieblok}>
          ...
          <BlokEenDerde
            ...
            from={"Van coachee David"}
            content={
              "“Als trainer Persoonlijk Leiderschap heeft Jet een onuitwisbare indruk op mij achtergelaten.\nJet is een bijzonder warm mens die klaar staat voor anderen. De manier waarop zij iemand een spiegel kan voorhouden, leidt ertoe dat diegene nieuwe zaken over zichzelf te weten komt en het vertrouwen in zichzelf kan terugvinden.\nIk beveel Jet dan ook van harte aan als trainer!”"
            }
          />
          <AccentBlok
            title={"Missie"}
